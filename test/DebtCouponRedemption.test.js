...
describe("DebtCoupon Redemption Contract", function() {
  ...
  describe("Deployment", function() {
    it("Print relevant addresses", async function() {
      ...
      console.log(
        "Balance of DebtCoupon " +
          (await deployedDebtCoupon.balanceOf(owner.address, 123))
      );
      ...
      deployedRedemptionContract
        ...
        .then(res => console.log("Transfer completed", res))
        .catch(res => console.error("Transfer failed", res));
      ...
      console.log(
        "Balance of DebtCoupon contract " +
          (await deployedDebtCoupon.balanceOf(
            deployedRedemptionContract.address,
            123
          ))
      );
